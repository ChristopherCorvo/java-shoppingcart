...
INSERT INTO USERS(USERID, USERNAME, PRIMARYEMAIL, PASSWORD, COMMENTS, CREATED_BY, CREATED_DATE, LAST_MODIFIED_BY, LAST_MODIFIED_DATE)
     VALUES (1, 'admin', 'barnbarn@host.local', '$2y$12$kAblc2BoEV47fAZKIBF09OHk7OHHEGiDtZDDrD560L/ldGfLQXMd6', '', 'SYSTEM', CURRENT_TIMESTAMP, 'SYSTEM', CURRENT_TIMESTAMP),
            (2, 'cinnamon', 'cinnamon@host.local', '$2y$12$pDC.sXLW/A4ZbT6z2TtDWeyrW5343tb.y7yTXNr.LS69UA.oQOuY2', '', 'SYSTEM', CURRENT_TIMESTAMP, 'SYSTEM', CURRENT_TIMESTAMP),
            (3, 'stumps', 'stumps@host.local',    '$2y$12$KevQhjXXkrK/MKmNwG7uAOVXgJVeaxOyISj4LhCPEpFz.cSlPULfK', '',  'SYSTEM', CURRENT_TIMESTAMP, 'SYSTEM', CURRENT_TIMESTAMP);
